...
{
    internal sealed class IncreaseCartAmountHandler : IRequestHandler<IncreaseCartAmountCommand, CartDto>
    {
        public readonly IUnitOfWork unitOfWork;
        public readonly ICurrentUserService currentUserService;
        public IncreaseCartAmountHandler(IUnitOfWork _unitOfWork, ICurrentUserService _currentUserService)
        {
            unitOfWork = _unitOfWork;
            currentUserService = _currentUserService;
        }

        public async Task<CartDto> Handle(IncreaseCartAmountCommand request, CancellationToken cancellationToken)
        {
